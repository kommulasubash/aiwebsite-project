...
let Api_url=  "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyCZdkaiuxd4PaXYg_zqWQplSTVCJqZJHi0"
...
speak(time)
  ...
  let finalText="this is what i found on internet regarding" + message.replace("BAKI","") || message.replace("shifra","")
  speak(finalText)
  window.open(`https://www.google.com/search?q=${message.replace("BAKI","")}`,"_blank")
}
}
